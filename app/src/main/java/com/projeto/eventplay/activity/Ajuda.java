...
public class Ajuda extends AppCompatActivity {
    ...
    private void deslogarUsuario() {
        ...
        Intent intent = new Intent(Ajuda.this, Login.class);
        startActivity(intent);
        finish();
    }

    private void abrirMeusEventosCriados(){
        Intent intent = new Intent( Ajuda.this, MeusEventosCriados.class );
        startActivity(intent);

    }

    private void abrirMapa(){
        Intent intent = new Intent( Ajuda.this, MapaActivity.class );
        startActivity(intent);

    }

    private void abrirContato(){
        Intent intent = new Intent (Ajuda.this, Contato.class);
        startActivity(intent);
    }

    private void abrirFavoritos(){
        Intent intent = new Intent (Ajuda.this, Favoritos.class);
        startActivity(intent);
    }
}
